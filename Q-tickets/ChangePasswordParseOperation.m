//
//  ChangePasswordParseOperation.m
//  SMSCountry
//
...
@implementation ChangePasswordParseOperation
@synthesize status,errorCode,message,chngePwdDict,userVO;
...
- (void)main
{
    ...
    chngePwdDict = [[NSMutableDictionary alloc]init];
...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict{
    ...
    if ([currentElement isEqualToString:RESULT]) {
        ...
        [chngePwdDict setValue:status forKey:STATUS];
        errorCode = [attributeDict objectForKey:ERRORCODE];
        [chngePwdDict setValue:errorCode forKey:ERRORCODE];
        message = [attributeDict objectForKey:ERROR_MESSAGE];
        [chngePwdDict setValue:message forKey:ERROR_MESSAGE];
        
        [outputArr addObject:chngePwdDict];
    }
